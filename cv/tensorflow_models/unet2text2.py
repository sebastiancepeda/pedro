...
def get_model_definition(img_height, img_width, in_channels, out_channels):
    ...
    x = Conv2D(10, **kwargs_conv2d)(x)
    x = Conv2D(10, **kwargs_conv2d)(x)
    x = AveragePooling2D((2, 2))(x)
    x = Conv2D(20, **kwargs_conv2d)(x)
    x = Conv2D(20, **kwargs_conv2d)(x)
    x = AveragePooling2D((2, 2))(x)
    x = Conv2D(40, **kwargs_conv2d)(x)
    x = Conv2D(40, **kwargs_conv2d)(x)
    x = AveragePooling2D((2, 2))(x)
    x = Conv2D(80, **kwargs_conv2d)(x)
    x = Conv2D(80, **kwargs_conv2d)(x)
    x = AveragePooling2D((2, 2))(x)
    x = Conv2D(160, **kwargs_conv2d)(x)
    x = Conv2D(160, **kwargs_conv2d)(x)
    x = AveragePooling2D((2, 1))(x)
    x = Conv2D(320, **kwargs_conv2d)(x)
    x = Conv2D(320, **kwargs_conv2d)(x)
    x = AveragePooling2D((2, 1))(x)
    x = Conv2D(640, **kwargs_conv2d)(x)
    x = Conv2D(640, **kwargs_conv2d)(x)
